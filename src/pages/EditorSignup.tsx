...
export const EditorSignup = () => {
  ...
  const handleSignup = async () => {
    const { name, email, password, confirmPassword, experience } = formData;
    
    if (!name || !email || !password || !confirmPassword || !experience) {
      toast({
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Welcome to Clippin! Your editor account is ready.",
      });
        ...
        <Card className="glass-card">
          <CardHeader className="text-center">
            ...
            <p className="text-muted-foreground">
              Join as an editor and start creating clips
            </p>
          </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="experience" className="text-sm font-rajdhani font-medium">
                Experience Level
              </Label>
              <Input
                id="experience"
                ...
                placeholder="e.g., 2 years video editing"
                className="bg-background/50 border-white/20"
              />
            </div>
